...
grep -h '^JNIEXPORT .* Java_' /c/Users/bp1user.SYDGRAM/Downloads/PortableGit/gcj/classpath/include/*.h | \
...
find /c/Users/bp1user.SYDGRAM/Downloads/PortableGit/gcj/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /c/Users/bp1user.SYDGRAM/Downloads/PortableGit/gcj/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /c/Users/bp1user.SYDGRAM/Downloads/PortableGit/gcj/classpath/native/jni -name \*.cpp | \
